...
const Step3 = () => {
    ...
    // data states
    const [question, setQuestion] = React.useState(allData ? allData.question : '');
    const [option1, setOption1] = React.useState(allData ? allData.options[0] : '');
    const [option2, setOption2] = React.useState(allData ? allData.options[1] : '');
    const [option3, setOption3] = React.useState(allData ? allData.options[2] : '');
    const [option4, setOption4] = React.useState(allData ? allData.options[3] : '');
        ...
        <div className='question_step3'>
            ...
            <div className="step3__input2 w-100 d-flex align-items-center gap-5 mt-4">
                <div className="left w-100 d-flex flex-column">
                    ...
                    <label className='markAs'>
                        <p
                            className={allData && allData.answer === 1 ? 'active' : answer === 1 ? 'active' : ''}
                        >
                ...
                <div className="right w-100 d-flex flex-column">
                    ...
                    <label className='markAs'>
                        <p
                            className={allData && allData.answer === 2 ? 'active' : answer === 2 ? 'active' : ''}
                        >
                            <ion-icon name="checkmark-outline"></ion-icon>
                        </p>
                        <input
            ...
            <div className="step3__input3 w-100 d-flex align-items-center gap-5 mt-4">
                <div className="left w-100 d-flex flex-column">
                    ...
                    <label className='markAs'>
                        <p
                            className={allData && allData.answer === 3 ? 'active' : answer === 3 ? 'active' : ''}
                        >
                            <ion-icon name="checkmark-outline"></ion-icon>
                        </p>
                        <input
                ...
                <div className="right w-100 d-flex flex-column">
                    ...
                    <label className='markAs'>
                        <p
                            className={allData && allData.answer === 4 ? 'active' : answer === 4 ? 'active' : ''}
                        >
                            <ion-icon name="checkmark-outline"></ion-icon>
                        </p>
                        <input
