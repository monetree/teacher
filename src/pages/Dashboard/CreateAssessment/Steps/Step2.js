        ...
        <div className="details__modal__content d-flex flex-column">
          ...
          <div className="modal_info flex-grow-1">
            ...
            <p className="question_title">
              {selected !== 0 && data.getQuestions[selected - 1].question_info}
            </p>
            ...
            <div className="modal_options">
              {selected !== 0 &&
                data.getQuestions[selected - 1].options.map((option, index) => (
                  <div
                    className={
                      data.getQuestions[selected - 1].answer === index + 1
                        ? "selected_option ans"
                        : "selected_option"
                    }
                    key={index}
                  >
                    <p>
                      Option {index + 1}{" "}
                      {parseInt(data.getQuestions[selected - 1].answer) ===
                      index + 1
                        ? ": Marked as Answer"
                        : ""}
                    </p>
