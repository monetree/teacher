...
const Dashboard = () => {
    ...
    const handleSearch = () => {
        ...
        if (search !== '') {
            const filtered = assessments.filter(item => item.name.toLowerCase().includes(search.toLowerCase()));
        ...
        <section className='dashboard__page'>
            <div className="topbar py-3 px-5 d-flex align-items-center gap-5">
                ...
                <div className="search flex-grow-1 d-flex align-items-center">
                    <input ref={searchRef} onChange={handleSearch} type="text" placeholder="Search assessment or Student" className='w-100' />
